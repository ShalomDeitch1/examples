...
public class MessagingInitializer {
    ...
    // Extracted helpers for clarity and testability
    ...
    String fetchQueueArn(String queueUrl) {
        return sqsClient.getQueueAttributes(GetQueueAttributesRequest.builder()
                .queueUrl(queueUrl).attributeNames(software.amazon.awssdk.services.sqs.model.QueueAttributeName.QUEUE_ARN).build())
