...
public class SqsNotificationListener {
    ...
    private void ensureQueueUrl() {
        ...
        String expectedQueueName = getExpectedQueueName();
        var urls = listQueueUrls();
    ...
    protected String getExpectedQueueName() {
        return "s3-notif-queue-" + bucketName;
    }

    protected List<String> listQueueUrls() {
