...
class RabbitMqPullIntegrationTest {
  ...
  static void registerProps(DynamicPropertyRegistry registry) {
    ...
    registry.add("waitingroom.rabbitmq.exchange", () -> "waiting-room");
    registry.add("waitingroom.rabbitmq.queue", () -> "waiting-room");
    registry.add("waitingroom.rabbitmq.routing-key", () -> "join");
  }
